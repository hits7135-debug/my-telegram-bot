...
# UPDATED API DETAILS FROM SCREENSHOT
...
# UPDATED DURATION MAP TO MATCH RESELLER WEBSITE EXACTLY
DAYS_MAP = {
    "1h": "1 Hours", "3h": "3 Hours", "6h": "6 Hours",
    "1d": "1 Days", "2d": "2 Days", "3d": "3 Days", "5d": "5 Days", "7d": "7 Days", 
...
def callback_listener(call):
    ...
    if action == "nav":
        ...
        if order_id in pending_orders:
            ...
            delivery_msg = f"✅ Payment Successful!\n🎮 Game: {gname}\n⌛ Duration: {dstr}\n🔑 Key: `{key}`\n\n{cur_footer}\n\nPANEL SETUP AND APK LINK {cur_link}"
